...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealElements = document.querySelectorAll('.scroll-reveal-left, .scroll-reveal-right, .fade-in-section');
    ...
    if (heroBg) {
        window.addEventListener('scroll', () => {
            ...
            if (scrollValue < window.innerHeight) {
                ...
                heroBg.style.transform = `scale(1.1) translateY(${scrollValue * 0.4}px)`;
            }
        });
    }
